...
<?php $options = array(
        ...
        <div class="form-actions">
            <br/>
            <input type="submit" name="save" class="btn btn-primary" value="Edit Tournament" />
    ...
    <?php if ($this->auth->has_permission('Tournament.Content.Delete')) : ?>
            ...
            or <button type="submit" name="delete" class="btn btn-danger" id="delete-me" onclick="return confirm('<?php echo lang('tournament_delete_confirm'); ?>')">
            <i class="icon-trash icon-white">&nbsp;</i>&nbsp;<?php echo lang('tournament_delete_record'); ?>
            </button>
